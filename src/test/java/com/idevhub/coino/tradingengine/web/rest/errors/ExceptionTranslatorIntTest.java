package com.idevhub.coino.tradingengine.web.rest.errors;
...
import com.idevhub.coino.tradingengine.service.client.TradingAccountFeignClient;
...
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, TradingengineApp.class})
@Ignore
public class ExceptionTranslatorIntTest {
    ...
    @MockBean
    private TradingAccountFeignClient tradingAccountFeignClient;
    ...
    public void setup() {
        ...
        Map<String, MarketStatus> marketStatuses = new HashMap<>();
        marketStatuses.put("LTC/BTC", MarketStatus.ACTIVE);

        doReturn(ResponseEntity.ok(marketStatuses)).when(tradingAccountFeignClient).getMarketStatusSetting();
